...
[https://dmagee-anonboard.herokuapp.com/](https://dmagee-anonboard.herokuapp.com/)
...
```
git clone https://github.com/yourUsername/anon-message-board.git
```
...
```
MONGO_URI=mongodb://localhost:27017/anondb
```
